...
@section('content')
    ...
    <form method="POST" action="{{ route('admin.pages.update', $page) }}">
        ...
        <div class="form-group">
            ...
            <select id="parent" class="form-control{{ $errors->has('parent_id') ? ' is-invalid' : '' }}" name="parent_id">
                <option value=""></option>
                @foreach ($parents as $parent)
                    <option value="{{ $parent->id }}"{{ $parent->id == old('parent_id', $page->parent_id) ? ' selected' : '' }}>
